...
<li>The user can choose Toggle anytime to switch stores</li>
 ...
 <li>Have flipped the axis in count the items and items damaged and items sold in both northside and southside store.So the x axis should have been y and y axis should have been x</li>
